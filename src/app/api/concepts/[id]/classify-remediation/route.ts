/**
 * API Route: /api/concepts/[id]/classify-remediation
 *
...
const SYSTEM_PROMPT = `You are a classification assistant. Given a user's description of what they want to do to a concept in a lexical resource, you must classify their intent into exactly one remediation strategy from the list below.
...
- If the user wants to change the concept's name/title, use "update_frame_label".
- If the user wants to change the main definition, use "update_frame_definition".
- If the user wants to move the concept under a different parent, use "reparent_frame".
- If the user wants to split a concept into multiple concepts, use "split_frame".
