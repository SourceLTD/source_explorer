...
const VERB_VARIABLES: VariableDefinition[] = [
  ...
  { key: 'frame_code', label: 'Frame code', category: 'relation' },
  { key: 'frame_definition', label: 'Frame definition', category: 'relation' },
  { key: 'transitive', label: 'Transitive', category: 'basic' },
  { key: 'vendler_class', label: 'Vendler class', category: 'basic' },
  { key: 'particles', label: 'Particles', category: 'basic' },
  { key: 'concrete', label: 'Concrete', category: 'basic' },
  { key: 'predicate', label: 'Predicate', category: 'basic' },
...
const FRAME_VARIABLES: VariableDefinition[] = [
  ...
  { key: 'code', label: 'Frame Code', category: 'basic' },
  { key: 'pos', label: 'Part of Speech', category: 'computed' },
  { key: 'framebank_id', label: 'FrameBank ID', category: 'basic' },
  ...
  { key: 'prototypical_synset_definition', label: 'Prototypical Synset Definition', category: 'basic' },
  { key: 'is_supporting_frame', label: 'Is Supporting Frame', category: 'basic' },
  { key: 'communication', label: 'Communication', category: 'basic' },
  { key: 'roles_count', label: 'Number of roles', category: 'computed' },
